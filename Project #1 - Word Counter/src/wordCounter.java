...
public class wordCounter {
    ...
    public static void main(String args[]) {
        ...
        Map<String, Integer> wordCount = generateWordMap(filename,
                seperatorsSet);
    ...
    /**
     * Generates a {@code set} of characters which includes the forbidden
     * characters
     * 
    ...
    /**
     * Generates a {@code map} with contains all the words and their respective
     * occurrence value
     * 
     ...
     * </pre>
     */
    private static Map<String, Integer> generateWordMap(String fileName,
            Set<Character> seperatorsSet) {
        ...
        while (!file.atEOS()) {
            ...
            while (linePos < line.length()) {
                String currentLine = nextWordOrSeparator(line, linePos,
                        seperatorsSet);
     ...
     *            occurrences
     * @param order
     *            the {@code Comparator} allowing the words inside of queue to
     ...
     * the given {@code position}. *REMEMBER* Dont use string concatnation
     * inside a loop, use substrings
     * 
     * @param text
    ...
    private static String nextWordOrSeparator(String text, int position,
        ...
        if (!separators.contains(text.charAt(position))) { //Found Letter
            ...
            while (positonCopy < text.length()
                    && !separators.contains(text.charAt(positonCopy))) {
                positonCopy++;
            }
    ...
    /**
     * Prints out an index page in HTML that holds the table which contains all
     * the words
     *
     * @param fileName
     *            the input file name
     ...
     *
     */
    private static void outputToHTML(String fileName, String outputFilename,
            Map<String, Integer> words, Queue<String> key) {
        ...
        assert !outputFilename
                .isEmpty() : "Violation of: outputFilename is empty!";
