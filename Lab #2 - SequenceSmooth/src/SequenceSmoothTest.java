...
public final class SequenceSmoothTest {
	...
	public void test7() {
         ...
         * Set up variables and call method under test
         */
        Sequence<Integer> seq1 = this.createFromArgs(7, 32, 2, 6);
        Sequence<Integer> expectedSeq1 = this.createFromArgs(7, 32, 2, 6);
        Sequence<Integer> seq2 = this.createFromArgs(1, 2, 3);
	...
	public void test8() {
         ...
         * Set up variables and call method under test
         */
        Sequence<Integer> seq1 = this.createFromArgs(7, 32, 2, 6, 10);
        Sequence<Integer> expectedSeq1 = this.createFromArgs(7, 32, 2, 6, 10);
        Sequence<Integer> seq2 = this.createFromArgs(4, 5, 6, 7, 8, 9);
        Sequence<Integer> expectedSeq2 = this.createFromArgs(15, 12, 4, 8);
        SequenceSmooth.smooth(seq1, seq2);
        /*
         * Assert that values of variables match expectations
         */
	...
	public void test9() {
         ...
         * Set up variables and call method under test
         */
        Sequence<Integer> seq1 = this.createFromArgs(18, 5, 9, 84);
        Sequence<Integer> expectedSeq1 = this.createFromArgs(18, 5, 9, 84);
        Sequence<Integer> seq2 = this.createFromArgs(12, 15, 420, 14);
        Sequence<Integer> expectedSeq2 = this.createFromArgs(11, 7, 46);
        SequenceSmooth.smooth(seq1, seq2);
        /*
         * Assert that values of variables match expectations
         */
	...
	public void test10() {
        ...
        Sequence<Integer> seq2 = this.createFromArgs(1, 4, 5);
